...
const Contact = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-[#f7f8f8]">
      <div className="w-full pt-15 pb-15">
        ...
        {/* Contact Cards */}
        <div className="flex flex-col lg:flex-row gap-4 mt-25 justify-center w-full cursor-pointer">
