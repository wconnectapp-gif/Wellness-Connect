...
const Contact = () => {
  ...
  return (
    <div className="bg-[#f7f8f8]">
      <div className="w-full max-w-3xl mx-auto pt-15 pb-15">
        ...
        {/* Contact Cards */}
        <div className="flex gap-4 mt-25 justify-center w-full cursor-pointer flex-wrap">
          <div className="flex flex-col bg-white w-60 text-base h-30 rounded-xl shadow-lg border border-gray-200 items-start p-3 leading-relaxed ">
        ...
        <div className="mt-25 p-4">
          <h2 className="flex font-bold text-xl text-[#111827] border-b border-gray-200 pb-3">
            Contact Form
          </h2>
        </div>
        {/* Contact Input */}
        <div className="mt-10 grid grid-cols-2 gap-4 md:grid-cols-2 p-4 ">
          <fieldset>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 mb-30 flex justify-between mt-20 h-25 items-center mx-4">
          <div className="flex flex-col">
